...
public readonly struct NestedOrderParquetMemorySource
{
    ...
    public NestedOrderParquetParallelSource Parallel(int maxDegreeOfParallelism = -1)
        => new NestedOrderParquetParallelSource(_bytes, _options, maxDegreeOfParallelism);
...
public readonly struct NestedOrderParquetParallelSource
{
    ...
    internal NestedOrderParquetParallelSource(global::System.ReadOnlyMemory<byte> bytes, global::Parquet.SourceGenerator.ParquetSerializerOptions? options, int maxDegreeOfParallelism)
    {
        _bytes = bytes;
        _options = options;
    ...
    public NestedOrderParquetParallelSource WithOptions(global::Parquet.SourceGenerator.ParquetSerializerOptions options)
        => new NestedOrderParquetParallelSource(_bytes, options ?? throw new global::System.ArgumentNullException(nameof(options)), _maxDegreeOfParallelism);

    /// <summary>Executes the read.</summary>
    public global::System.Threading.Tasks.Task<global::System.Collections.Generic.List<NestedOrder>> ToListAsync(global::System.Threading.CancellationToken cancellationToken = default)
        => NestedOrderParquetExtensions.ReadParquetParallelAsync(_bytes, _maxDegreeOfParallelism, _options, cancellationToken);

    /// <summary>Executes the read.</summary>
    public global::System.Threading.Tasks.Task<NestedOrder[]> ToArrayAsync(global::System.Threading.CancellationToken cancellationToken = default)
        => NestedOrderParquetExtensions.ReadParquetParallelArrayAsync(_bytes, _maxDegreeOfParallelism, _options, cancellationToken);
