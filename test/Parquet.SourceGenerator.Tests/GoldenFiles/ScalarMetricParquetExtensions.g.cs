...
public static partial class ScalarMetricParquetExtensions
{
    ...
    /// <summary>
    /// Asynchronously deserializes all <c>ScalarMetric</c> objects from a Parquet file on disk, mapping the
    ...
    /// <summary>
    /// Asynchronously deserializes all <c>ScalarMetric</c> objects from a Parquet file on disk into an array,
    ...
    /// <summary>
    /// Asynchronously deserializes all <c>ScalarMetric</c> objects from a Parquet file on disk,
    /// decoding row groups across multiple workers over the mapped file.
    /// </summary>
    public static async global::System.Threading.Tasks.Task<global::System.Collections.Generic.List<ScalarMetric>> ReadParquetParallelAsync(
        global::System.IO.FileInfo file,
    ...
    /// <summary>
    /// Asynchronously streams <c>ScalarMetric</c> items from a Parquet file on disk, row group by row group.
    /// </summary>
    public static async global::System.Collections.Generic.IAsyncEnumerable<ScalarMetric> ReadParquetStreamAsync(
        global::System.IO.FileInfo file,
        global::Parquet.SourceGenerator.ParquetSerializerOptions? options = null,
