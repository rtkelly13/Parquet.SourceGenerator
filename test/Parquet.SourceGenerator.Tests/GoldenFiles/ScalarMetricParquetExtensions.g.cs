...
public static partial class ScalarMetricParquetExtensions
{
    ...
    /// </remarks>
    public static global::System.Collections.Generic.IAsyncEnumerable<ScalarMetric> ReadParquetStreamAsync(
        global::System.IO.Stream stream,
        global::Parquet.SourceGenerator.ParquetSerializerOptions? options = null,
        global::System.Threading.CancellationToken cancellationToken = default)
    {
    ...
    /// <summary>
    /// Streams <c>ScalarMetric</c> items with no overlap: each row group is decoded only once the
    /// caller has finished the previous one. This is the historic behaviour and remains the default.
    /// </summary>
    private static async global::System.Collections.Generic.IAsyncEnumerable<ScalarMetric> ReadParquetStreamSequentialAsync(
        global::System.IO.Stream stream,
    ...
    /// <summary>
    /// One decoded row group in flight: a pooled <c>ScalarMetric[]</c> and the number of live entries in it.
    /// </summary>
    private readonly struct PrefetchedRowGroup
    {
        public PrefetchedRowGroup(ScalarMetric[] items, int count)
        {
            Items = items;
            Count = count;
        }

        public ScalarMetric[] Items { get; }

        public int Count { get; }
    }

    /// <summary>
    /// Streams <c>ScalarMetric</c> items while a background task runs ahead decoding the next row group.
    /// </summary>
    private static async global::System.Collections.Generic.IAsyncEnumerable<ScalarMetric> ReadParquetStreamPrefetchedAsync(
        global::System.IO.Stream stream,
        global::Parquet.SourceGenerator.ParquetSerializerOptions options,
        int prefetchDepth,
        [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken)
        ...
        try
        {
            while (await channel.Reader.WaitToReadAsync(cancellationToken).ConfigureAwait(false))
            {
                while (channel.Reader.TryRead(out var prefetched))
                {
                    ...
                    {
                        global::System.Buffers.ArrayPool<ScalarMetric>.Shared.Return(prefetched.Items, clearArray: true);
                    }
                }
            }
        }
    ...
    /// <summary>
    /// Reads, decodes and materialises every row group of <c>ScalarMetric</c>, publishing each one to the
        ...
        global::System.Threading.CancellationToken cancellationToken)
    {
        try
        {
            ...
            for (int r = 0; r < reader.RowGroupCount; r++)
            {
                ...
                using var groupReader = reader.OpenRowGroupReader(r);
                int rowCount = (int)groupReader.RowCount;
                var items = global::System.Buffers.ArrayPool<ScalarMetric>.Shared.Rent(rowCount);
                ...
                finally
                {
                    ...
                    if (!published)
                    {
                        global::System.Buffers.ArrayPool<ScalarMetric>.Shared.Return(items, clearArray: true);
                    }
                }
            }
        }
