        ...
        for (int r = 0; r < reader.RowGroupCount; r++)
        {
            ...
            try
            {
                ...
                if (!missing_1)
                {
                    ...
                    {
                        throw new global::System.IO.InvalidDataException($"Dictionary column 'Name' value count {metadata_1.NumValues} exceeds maximum allowed {options.MaxDictionaryEntries}.");
                    }
                }
                ...
                {
                    throw new global::System.IO.InvalidDataException($"Dictionary column 'Score' value count {metadata_2.NumValues} exceeds maximum allowed {options.MaxDictionaryEntries}.");
                }
                ...
                {
                    throw new global::System.IO.InvalidDataException($"Dictionary column 'Price' value count {metadata_3.NumValues} exceeds maximum allowed {options.MaxDictionaryEntries}.");
                }
                ...
                {
                    throw new global::System.IO.InvalidDataException($"Dictionary column 'CreatedAt' value count {metadata_4.NumValues} exceeds maximum allowed {options.MaxDictionaryEntries}.");
                }
                ...
                {
                    throw new global::System.IO.InvalidDataException($"Dictionary column 'Duration' value count {metadata_5.NumValues} exceeds maximum allowed {options.MaxDictionaryEntries}.");
                }
                await groupReader.ReadAsync<int>(
                    field_5,
                ...
                {
                    throw new global::System.IO.InvalidDataException($"Dictionary column 'CorrelationId' value count {metadata_6.NumValues} exceeds maximum allowed {options.MaxDictionaryEntries}.");
                }
                ...
                if (!missing_7)
                {
                    ...
                    {
                        throw new global::System.IO.InvalidDataException($"Dictionary column 'OptionalGuid' value count {metadata_7.NumValues} exceeds maximum allowed {options.MaxDictionaryEntries}.");
                    }
                }
                // The column is absent from the file (optional-column schema evolution) or the chunk is
                // entirely null: either way the answer is nulls, with no page read, decompression or decoding.
                ...
                if (!missing_8)
                {
                    ...
                    {
                        throw new global::System.IO.InvalidDataException($"Dictionary column 'Payload' value count {metadata_8.NumValues} exceeds maximum allowed {options.MaxDictionaryEntries}.");
                    }
                }
                // The column is absent from the file (optional-column schema evolution) or the chunk is
                // entirely null: either way the answer is nulls, with no page read, decompression or decoding.
