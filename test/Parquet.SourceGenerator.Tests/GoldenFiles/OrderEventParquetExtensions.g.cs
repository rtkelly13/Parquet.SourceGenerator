...
public readonly struct OrderEventRowGroupMetadata
{
    ...
    internal OrderEventRowGroupMetadata(
        int rowGroupIndex,
        long rowCount,
        bool hasStatistics,
...
/// <summary>
/// Entry point for reading <c>OrderEvent</c> values from Parquet (issues #217, #478).
/// </summary>
public static partial class OrderEventParquet
{
    ...
    public static OrderEventParquetReader From(global::System.IO.Stream stream)
        => new OrderEventParquetReader(stream ?? throw new global::System.ArgumentNullException(nameof(stream)), default, null, null, false);

    /// <summary>Reads from an in-memory buffer. The only source that supports <c>Parallel()</c>.</summary>
    public static OrderEventParquetReader From(global::System.ReadOnlyMemory<byte> parquetBytes)
        => new OrderEventParquetReader(null, parquetBytes, null, null, false);
}

/// <summary>
/// A pending read of <c>OrderEvent</c> (issue #478).
/// </summary>
/// <remarks>
...
public readonly struct OrderEventParquetReader
{
    ...
    internal OrderEventParquetReader(global::System.IO.Stream? stream, global::System.ReadOnlyMemory<byte> bytes, global::Parquet.SourceGenerator.ParquetSerializerOptions? options, global::System.Func<global::SampleDomain.Models.OrderEventRowGroupMetadata, bool>? predicate, bool parallel)
    {
        _stream = stream;
        _bytes = bytes;
        _options = options;
    ...
    public OrderEventParquetReader WithOptions(global::Parquet.SourceGenerator.ParquetSerializerOptions options)
        => new OrderEventParquetReader(_stream, _bytes, options ?? throw new global::System.ArgumentNullException(nameof(options)), _predicate, _parallel);
    ...
    public OrderEventParquetReader Where(global::System.Func<global::SampleDomain.Models.OrderEventRowGroupMetadata, bool> predicate)
    {
        ...
        return new OrderEventParquetReader(_stream, _bytes, _options, predicate, _parallel);
    }
    ...
    /// </remarks>
    /// <exception cref="System.NotSupportedException">The source is a stream (use <c>OrderEventParquet.From(ReadOnlyMemory&lt;byte&gt;)</c>), or the reader has a <c>Where()</c> predicate.</exception>
    public OrderEventParquetReader Parallel()
    {
        if (_stream is not null)
            throw new global::System.NotSupportedException("Parallel() is not supported on a Stream source: a single ParquetReader seeks within its stream, so row groups cannot be decoded concurrently. Buffer the file and read it with OrderEventParquet.From(ReadOnlyMemory<byte>), the parallel source.");
        if (_predicate is not null)
        ...
        return new OrderEventParquetReader(_stream, _bytes, _options, _predicate, true);
    }
    ...
    {
        if (_parallel)
            return OrderEventParquetExtensions.ReadParallelArrayCoreAsync(_bytes, _options, cancellationToken);
        if (_stream is not null)
            return OrderEventParquetExtensions.ReadArrayCoreAsync(_stream, _options, cancellationToken, _predicate);
        if (_predicate is not null)
            return CollectFilteredBufferAsync(_bytes, _options, _predicate, cancellationToken);
        return OrderEventParquetExtensions.ReadArrayCoreAsync(_bytes, _options, cancellationToken);
    }
    ...
    private static async global::System.Threading.Tasks.Task<OrderEvent[]> CollectFilteredBufferAsync(global::System.ReadOnlyMemory<byte> bytes, global::Parquet.SourceGenerator.ParquetSerializerOptions? options, global::System.Func<global::SampleDomain.Models.OrderEventRowGroupMetadata, bool> predicate, global::System.Threading.CancellationToken cancellationToken)
    {
        var results = new global::System.Collections.Generic.List<OrderEvent>();
        await foreach (var item in OrderEventParquetExtensions.ReadEnumerableCoreAsync(bytes, options, cancellationToken, predicate))
            results.Add(item);
