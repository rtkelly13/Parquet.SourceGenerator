...
public readonly struct OrderEventParquetMemorySource
{
    ...
    public OrderEventParquetParallelSource Parallel(int maxDegreeOfParallelism = -1)
        => new OrderEventParquetParallelSource(_bytes, _options, maxDegreeOfParallelism);
...
public readonly struct OrderEventParquetParallelSource
{
    ...
    internal OrderEventParquetParallelSource(global::System.ReadOnlyMemory<byte> bytes, global::Parquet.SourceGenerator.ParquetSerializerOptions? options, int maxDegreeOfParallelism)
    {
        _bytes = bytes;
        _options = options;
    ...
    public OrderEventParquetParallelSource WithOptions(global::Parquet.SourceGenerator.ParquetSerializerOptions options)
        => new OrderEventParquetParallelSource(_bytes, options ?? throw new global::System.ArgumentNullException(nameof(options)), _maxDegreeOfParallelism);

    /// <summary>Executes the read.</summary>
    public global::System.Threading.Tasks.Task<global::System.Collections.Generic.List<OrderEvent>> ToListAsync(global::System.Threading.CancellationToken cancellationToken = default)
        => OrderEventParquetExtensions.ReadParquetParallelAsync(_bytes, _maxDegreeOfParallelism, _options, cancellationToken);

    /// <summary>Executes the read.</summary>
    public global::System.Threading.Tasks.Task<OrderEvent[]> ToArrayAsync(global::System.Threading.CancellationToken cancellationToken = default)
        => OrderEventParquetExtensions.ReadParquetParallelArrayAsync(_bytes, _maxDegreeOfParallelism, _options, cancellationToken);
