...
public static partial class OrderEventParquetExtensions
{
    ...
    /// <summary>
    /// Asynchronously deserializes all <c>OrderEvent</c> objects from a Parquet file on disk, mapping the
    ...
    /// <summary>
    /// Asynchronously deserializes all <c>OrderEvent</c> objects from a Parquet file on disk into an array,
    ...
    /// <summary>
    /// Asynchronously deserializes all <c>OrderEvent</c> objects from a Parquet file on disk,
    /// decoding row groups across multiple workers over the mapped file.
    /// </summary>
    public static async global::System.Threading.Tasks.Task<global::System.Collections.Generic.List<OrderEvent>> ReadParquetParallelAsync(
        global::System.IO.FileInfo file,
    ...
    /// <summary>
    /// Asynchronously streams <c>OrderEvent</c> items from a Parquet file on disk, row group by row group.
    /// </summary>
    public static async global::System.Collections.Generic.IAsyncEnumerable<OrderEvent> ReadParquetStreamAsync(
        global::System.IO.FileInfo file,
        global::Parquet.SourceGenerator.ParquetSerializerOptions? options = null,
