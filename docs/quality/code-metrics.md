---
description: "Roslyn metrics baselines and the complexity ratchet."
order: 70
---

# Code Metrics & the Complexity Ratchet
...
> live in [Generated Code Metrics](./generated-code-metrics.md) — same computation, same
...
Before this, the repository measured its public surface ([Generated API Baselines](./api-baselines.md),
[API Change Contract](./api-change-contract.md)), its test coverage, and the correctness of its emitted output —
...
The same rules as [Generated API Baselines](./api-baselines.md):
...
("is our ruler accurate?" is a nightly question). See [Metrics Oracle (#254)](./metrics-oracle.md).
...
[Generated Code Metrics § Is emitted method size actionable?](./generated-code-metrics.md#is-emitted-method-size-actionable-no-watch-it-do-not-fix-it).
...
- [Generated API Baselines](./api-baselines.md) — the checked-in-artifact
  pattern this borrows wholesale.
- [Generated Code Metrics](./generated-code-metrics.md) — layer 2, the emitted half.
- [API Change Contract](./api-change-contract.md) — the gating philosophy. Note that the
