---
description: "Stryker over the behavioural suite only."
order: 120
---

# Mutation Testing (#251, layer 4)
...
baseline gets recorded into `docs/quality/mutation-headline.md`; the alternative is closing it.
