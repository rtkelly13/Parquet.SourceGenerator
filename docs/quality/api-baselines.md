---
description: "The .api.txt signature baseline beside every golden file."
order: 30
---
...
> profile matrix is a post-freeze follow-up recorded in [DECISIONS #227](../design/decisions.md#227--feature-profile-golden-matrix);
...
[API Change Contract](./api-change-contract.md), the same comparison also runs at **build** time as `PARQAPI001`,
...
[Generated Code Metrics](./generated-code-metrics.md). Those baselines read their member
...
[API Change Contract](./api-change-contract.md) now enforces this format as a **build
