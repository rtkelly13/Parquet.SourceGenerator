---
description: "dotnet-dump and SOS playbook."
order: 60
---

# Memory Triage with dotnet-dump
...
While [BenchmarkDotNet](./testing.md) measures elapsed execution time and total allocated bytes per operation, it does not reveal:
