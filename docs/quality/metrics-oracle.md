---
description: "Nightly cross-check against Microsoft's Metrics.exe."
order: 100
---

# Metrics Oracle (#254)

Layer 1's baselines (`metrics/*.metrics.txt`, [Code Metrics & the Complexity Ratchet](./code-metrics.md)) are
