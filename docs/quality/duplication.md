---
description: "Token-level duplication drift gate."
order: 90
---

# Duplication Gate (#251, layer 3)

Layers 1 ([Code Metrics & the Complexity Ratchet](./code-metrics.md)) and 2 ([Generated Code Metrics](./generated-code-metrics.md)) measure *volume and branching*. Neither can see the
