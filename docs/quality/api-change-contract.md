---
description: "The three governed API surfaces, their build gates and semver buckets."
order: 40
---
...
this document and [Generated API Baselines](./api-baselines.md), which
...
[Generated API Baselines §The grammar](./api-baselines.md#the-grammar) documents, which is the grammar
...
design — see [Generated API Baselines](./api-baselines.md), it is what makes the two unable to drift), so
...
shared MSBuild/assembly configuration channel documented in [Attributes & Configuration § Feature levels](../guide/attributes.md#4-feature-levels).

`0.0.x` permits breaking changes without a major bump; the release framing in
[0.1 Contract & Design Goals (#477)](../design/release-contract.md) says so, and that is not changing here. The bucket
...
| Thing | Where |
|:---|:---|
| Grammar for every catalogue line | [Generated API Baselines](./api-baselines.md) |
