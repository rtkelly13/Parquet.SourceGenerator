---
description: "Call-graph drift, cycle, fan-out and layering gates."
order: 110
---

# Call Graph Gates (#252)

Layers 1–3 ([Code Metrics & the Complexity Ratchet](./code-metrics.md), [Generated Code Metrics](./generated-code-metrics.md),
[Duplication Gate (#251, layer 3)](./duplication.md)) measure *volume, branching, and overlap* — all properties of
...
| type-level Mermaid of the generator | `docs/internals/callgraph.md` | refreshed by the same command |
| Mermaid of the generated code's graph — "what a consumer's debugger walks" | `docs/internals/callgraph-generated.md` | documentation only |
