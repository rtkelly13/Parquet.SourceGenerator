---
description: "Why compile-time generation, and the three components."
order: 10
---
...
For any marked type `UserRecord`, the source generator emits write extension methods and a read
builder entry point. This is simplified; the exact emitted surface is baselined in
`test/Parquet.SourceGenerator.Tests/GoldenFiles/*.api.txt`:
