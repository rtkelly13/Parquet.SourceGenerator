---
description: "Headline numbers, real-dataset runs and the benchmark regression gate."
order: 70
---
...
First read-suite measurement since the `List<T>.Capacity` fix (docs/guide/limitations.md §2.2) and the real parallel reader (§2.1), closing the audit's "reasoned rather than measured" note.
...
* [Performance Findings](../internals/performance-findings.md)
* [Buffer Reuse & Column Extraction](../internals/buffer-reuse.md)
