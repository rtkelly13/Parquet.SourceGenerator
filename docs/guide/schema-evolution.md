---
description: "Reordered, extra and missing columns, and cross-version results."
order: 50
---

# Schema Evolution

[Document 14](../reference/compatibility.md) declares what this generator promises. This document
...
Forward compatibility here means what the Compatibility Matrix page defines: a newer file is readable when it stays
...
- Any Parquet feature outside the envelope in the Compatibility Matrix page.
