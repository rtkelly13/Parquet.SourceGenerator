---
description: "Every PARQ diagnostic: cause, reason and fix."
order: 10
---
...
| **[`PARQ003`](#parq003-no-public-serializable-properties-found)** | **Warning** | No serializable properties found | Target type has no valid public serializable properties or fields. |
...
| **[`PARQ007`](#parq007-parquet-member-is-not-assignable)** | **Error** | Member not assignable | Member cannot be assigned by the generated deserializer. |
| **[`PARQ008`](#parq008-type-has-no-accessible-parameterless-constructor)** | **Error** | No parameterless constructor | Type has no accessible parameterless constructor (e.g. positional records). |
...
| **[`PARQ011`](#parq011-property-type-unsupported-on-classic-v5-api)** | **Error** | Unsupported on classic API | Member type is supported by Parquet.Net 6 but not by the 4.x/5.x API. |
