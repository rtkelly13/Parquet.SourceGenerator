---
description: "Type envelope, encodings, interop with PyArrow and DuckDB, and Arrow RecordBatch ingestion."
order: 20
---
...
`0.1.0` (#480, [Flat-Read Removal (#480)](../design/flat-read-removal.md)). The classic backend has no builder, so its
...
The backend-specific boundary in [DECISIONS #176](../design/decisions.md#176--nested-types-by-backend) qualifies these rows:
...
| Missing optional generated column | Supported | The column materialises as all-null; see [Schema Evolution](../guide/schema-evolution.md) |
...
| Older Parquet.Net output read by current generated code | Verified | Parquet.Net 6.0.3 fixtures in the version matrix (the Schema Evolution page) |
| Current generated output read by legacy consumers | Verified in CI | Cross-version package interop step (the Schema Evolution page) |
...
- [Issue #168](https://github.com/rtkelly13/Parquet.SourceGenerator/issues/168) adds version and schema-evolution testing; results in [Schema Evolution](../guide/schema-evolution.md).
