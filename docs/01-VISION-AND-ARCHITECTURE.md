...
builder entry point. This is simplified; the exact emitted surface is rendered per golden model as
`*.api.txt` by the test suite and shown in CI's derived-output review
