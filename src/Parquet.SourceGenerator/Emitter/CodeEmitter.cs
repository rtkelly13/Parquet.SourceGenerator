...
public static class CodeEmitter
{
    ...
    public static string EmitSource(TargetClassModel model)
    {
        ...
        // Read entry point and builder structs (#217). Each axis of the read grid becomes a member
        // rather than a name segment; see docs/17-PUBLIC-API-SURFACE.md. The flat Read* methods
        // above remain and are what these delegate to, for one release (decision D3).
